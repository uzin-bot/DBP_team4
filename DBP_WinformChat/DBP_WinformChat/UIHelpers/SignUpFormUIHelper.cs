...
namespace leehaeun.UIHelpers
{
    public static class SignUpFormUIHelper
    {
        ...
        private static void StyleTextBox(TextBox textBox, Form form)
        {
            ...
            textBox.BackColor = isReadOnly ? ColorSchemes.LightOlive : Themes.ColorSchemes.White;
            ...
            Panel wrapper = new Panel
            {
                ...
                BackColor = isReadOnly ? ColorSchemes.LightOlive : Themes.ColorSchemes.White,
                Tag = textBox.Name,
        ...
        private static void StyleComboBox(ComboBox comboBox, Form form)
        {
            ...
            EventHandler showMenu = (s, e) =>
            {
                ...
                menu.BackColor = Themes.ColorSchemes.White;
        ...
        private class CustomMenuRenderer : ToolStripProfessionalRenderer
        {
            ...
            protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
            {
                ...
                {
                    // 기본 배경
                    using (SolidBrush brush = new SolidBrush(Themes.ColorSchemes.White))
                    {
        ...
        private class CustomColorTable : ProfessionalColorTable
        {
            ...
            public override Color ImageMarginGradientBegin => Themes.ColorSchemes.White;
            public override Color ImageMarginGradientMiddle => Themes.ColorSchemes.White;
            public override Color ImageMarginGradientEnd => Themes.ColorSchemes.White;
            public override Color ToolStripDropDownBackground => Themes.ColorSchemes.White;
        }
        ...
        private static void StyleCameraButton(Button button)
        {
            button.FlatStyle = FlatStyle.Flat;
            button.FlatAppearance.BorderSize = 0;
            button.BackColor = Themes.ColorSchemes.White;
            button.Cursor = Cursors.Hand;
