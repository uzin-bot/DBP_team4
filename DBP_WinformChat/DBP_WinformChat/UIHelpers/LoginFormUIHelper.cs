...
namespace leehaeun.UIHelpers
{
    public static class LoginFormUIHelper
    {
        ...
        private static void StyleTextBox(TextBox textBox, Form form)
        {
            ...
            textBox.BackColor = Themes.ColorSchemes.White;
            ...
            Panel wrapper = new Panel
            {
                ...
                BackColor = Themes.ColorSchemes.White,
                Tag = textBox.Name
            };
            ...
            wrapper.Paint += (s, e) =>
            {
                ...
                {
                    using (Pen pen = new Pen(Themes.ColorSchemes.SageGreen, 0.8f))
                    {
        ...
        private static void StyleButton(Button button)
        {
            ...
            button.BackColor = Themes.ColorSchemes.SageGreen;
            button.ForeColor = Themes.ColorSchemes.White;
            ...
            button.MouseEnter += (s, e) => button.BackColor = Themes.ColorSchemes.DarkOlive;
            button.MouseLeave += (s, e) => button.BackColor = Themes.ColorSchemes.SageGreen;
        }
        ...
        private static void StyleCheckBox(CheckBox checkBox)
        {
            ...
            checkBox.BackColor = Themes.ColorSchemes.Ivory;
            checkBox.Font = new Font("맑은 고딕", 9F);
            checkBox.ForeColor = Themes.ColorSchemes.DarkOlive;
            ...
            checkBox.Paint += (s, e) =>
            {
                ...
                e.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
                e.Graphics.Clear(Themes.ColorSchemes.Ivory); // 배경 지우기
                ...
                if (isHover)
                {
                    bgColor = Themes.ColorSchemes.LightOlive;
                }
                else
                {
                    bgColor = cb.Checked ? Themes.ColorSchemes.SageGreen : Themes.ColorSchemes.White;
                }
                ...
                using (GraphicsPath path = GetRoundedRectangle(checkBoxRect, 4))
                {
                    ...
                    using (Pen pen = new Pen(Themes.ColorSchemes.SageGreen, 1.5f))
                    {
                ...
                if (cb.Checked)
                {
                    using (Pen pen = new Pen(Themes.ColorSchemes.White, 2f))
                    {
        ...
        private static void StyleLinkLabel(LinkLabel linkLabel)
        {
            ...
            linkLabel.LinkColor = Themes.ColorSchemes.SageGreen;
            linkLabel.ActiveLinkColor = Themes.ColorSchemes.DarkOlive;
            linkLabel.VisitedLinkColor = Themes.ColorSchemes.SageGreen;
            linkLabel.BackColor = Themes.ColorSchemes.Ivory;
            linkLabel.Cursor = Cursors.Hand;
            linkLabel.LinkBehavior = LinkBehavior.AlwaysUnderline;

            linkLabel.MouseEnter += (s, e) => linkLabel.LinkColor = Themes.ColorSchemes.DarkOlive;
