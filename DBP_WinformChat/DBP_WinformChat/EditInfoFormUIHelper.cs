    ...
    public static class EditInfoFormUIHelper
    {
        ...
        private static void CreateCustomTitleBar(Form form)
        {
            ...
            Button closeButton = new Button
            {
                Name = "closeButton",
                Text = "?",
                Font = new Font("∏º¿∫ ∞ÌµÒ", 11F, FontStyle.Bold),
                Size = new Size(50, 40),
        ...
        private static void CreateCustomTabs(Form form)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                {
                    Text = tabNames[i],
                    Font = new Font("∏º¿∫ ∞ÌµÒ", 10F, FontStyle.Bold),
        ...
        private static void StyleTextBox(TextBox textBox)
        {
            ...
            textBox.Font = new Font("∏º¿∫ ∞ÌµÒ", 10F);
        ...
        private static void StyleButton(Button button)
        {
            ...
            {
                button.Font = new Font("∏º¿∫ ∞ÌµÒ", 9F, FontStyle.Bold);
            ...
            {
                button.Font = new Font("∏º¿∫ ∞ÌµÒ", 10F, FontStyle.Bold);
        ...
        {
            label.Font = new Font("∏º¿∫ ∞ÌµÒ", 9F, FontStyle.Bold);
        ...
        private static void AdjustMulProfilePage(Panel page)
        {
            ...
            foreach (Control control in page.Controls)
            {
                ...
                {
                    control.Location = new Point(centerX, startY);
                    control.Font = new Font("∏º¿∫ ∞ÌµÒ", 12F, FontStyle.Bold);
                }
                ...
                else if (control.Name == "NicknameLabel")
                {
                    ...
                    control.Font = new Font("∏º¿∫ ∞ÌµÒ", 10F, FontStyle.Bold);
                }
                ...
                foreach (Control child in panel.Controls)
                {
                    ...
                    else if (child is Label lbl)
                    {
                        if (parentName == "ProfileFLP")
                        {
                            ...
                            lbl.Font = new Font("∏º¿∫ ∞ÌµÒ", 10F, FontStyle.Bold);
                        ...
                        else if (parentName == "MemberFLP")
                        {
                            ...
                            lbl.Font = new Font("∏º¿∫ ∞ÌµÒ", 8.5F, FontStyle.Bold);
                            lbl.ForeColor = ThemeManager.ColorScheme.DarkOlive;
                            lbl.BackColor = Color.Transparent;
                            lbl.AutoSize = false;
                    ...
                    else if (child is Button btn)
                    {
                        ...
                        btn.Font = new Font("∏º¿∫ ∞ÌµÒ", 9F, FontStyle.Bold);
