...
partial class Dept
{
	...
	private void InitializeComponent()
	{
		...
		headerPanel.Size = new Size(1184, 88);
		...
		gpinfo.Location = new Point(542, 112);
		...
		cbDept.Location = new Point(174, 220);
		cbDept.Margin = new Padding(3, 2, 3, 2);
		cbDept.Name = "cbDept";
		cbDept.Size = new Size(382, 33);
		cbDept.TabIndex = 7;
		// 
		// txtname
		// 
		...
		// txtID
		// 
		txtID.Location = new Point(174, 72);
		...
		change_profile_button.Location = new Point(209, 906);
		...
		rbDarkMode.Location = new Point(381, 909);
		rbDarkMode.Margin = new Padding(3, 2, 3, 2);
		rbDarkMode.Name = "rbDarkMode";
		rbDarkMode.Size = new Size(115, 29);
