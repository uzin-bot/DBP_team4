...
namespace leehaeun.UIHelpers
{
    public static class SignUpFormUIHelper
    {
        ...
        private static void StyleButton(Button button)
        {
            ...
            button.FlatAppearance.MouseDownBackColor = ThemeManager.ColorScheme.DarkOlive; // 클릭 시 색상
            button.FlatAppearance.MouseOverBackColor = ThemeManager.ColorScheme.DarkOlive; // 호버 시 색상
            ...
            button.GotFocus += (s, e) =>
            {
                button.BackColor = ThemeManager.ColorScheme.SageGreen; // 포커스 받아도 색상 유지
                button.Invalidate();
            };

            button.LostFocus += (s, e) =>
            {
                button.BackColor = ThemeManager.ColorScheme.SageGreen; // 포커스 잃어도 색상 유지
                button.Invalidate();
            };
